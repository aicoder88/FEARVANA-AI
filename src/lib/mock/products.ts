...
export const AKSHAY_AI_PRODUCTS: AICoachingProduct[] = [
  {
    ...
    description:
      "The World's First AI Coach Trained by a Marine Who Survived War, Addiction, and 500 Miles Alone in Antarctica",
    longDescription:
      `Transform ALL of Akshay's content (podcasts, book, expedition logs, keynotes) into a hyper-intelligent AI coach that delivers personalized "Fearvana transformations." Trained on his complete Antarctic expedition audio logs, military combat psychology, and extreme adventure mindset training.`,
    pricing: {
      monthly: 97,
      annual: 970,
    },
  ...
  },
  {
    ...
    longDescription:
      'Advanced version includes real-time expedition updates, priority AI responses, and access to exclusive content from ongoing adventures.',
    pricing: {
      monthly: 297,
      annual: 2970,
    },
  ...
  },
  {
    ...
    longDescription:
      `An AI system that breaks down "impossible" goals using Akshay's proven methodology from crossing polar ice caps to building businesses. Uses real expedition data showing how he conquered daily setbacks, weather disasters, equipment failures - applied to business challenges.`,
    pricing: {
      monthly: 197,
    },
    features: [
  ...
  },
  {
    ...
    longDescription:
      `AI trained on Akshay's journey from suicidal ideation to extreme performance. Incorporates his "Fearvana" methodology for transforming suffering into strength. Designed specifically for veterans and first responders.`,
    pricing: {
      monthly: 97,
    },
    features: [
    ...
    targetAudience: ['Military veterans', 'First responders', 'Combat veterans', 'PTSD sufferers'],
    category: 'individual',
    level: 'basic',
    status: 'active',
  },
  {
    ...
    longDescription:
      `Transform Akshay's polar expedition experience into AI coaching for ultramarathoners, mountain climbers, entrepreneurs facing "business expeditions," and anyone pursuing extreme physical/mental challenges.`,
    pricing: {
      monthly: 147,
    },
    features: [
  ...
  },
  {
    ...
    longDescription:
      `Scale Akshay's $25K+ corporate keynotes into comprehensive AI-powered transformation programs. Includes pre-workshop AI assessment, personalized coaching, and 90-day follow-up.`,
    pricing: {
      monthly: 25000,
    },
    features: [
  ...
  },
  {
    ...
    longDescription:
      `Real-time decision making under extreme duress from 60 days alone in the most hostile environment on Earth. Raw, unfiltered wisdom from humanity's edge with zero competition.`,
    pricing: {
      monthly: 67,
    },
    features: [
